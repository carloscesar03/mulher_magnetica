    ...
    <section id="oferta" className="py-20 px-6 bg-zinc-950 relative">
        ...
        <div className="max-w-4xl mx-auto bg-zinc-900 rounded-3xl p-8 lg:p-12 border border-rose-600/30 shadow-[0_0_50px_rgba(225,29,72,0.15)] text-center relative z-10 flex flex-col md:flex-row items-center gap-10">
            ...
            <div className="w-full md:w-1/2 flex justify-center">
                <img src="https://i.postimg.cc/xTQHd36D/mockup_combo_oferta_com_bonus_Photoroom.webp" alt="Combo Completo" loading="lazy" width="600" height="450" referrerPolicy="no-referrer" className="w-full max-w-md object-contain drop-shadow-2xl hover:scale-105 transition-transform duration-500" />
            </div>
            ...
            <div className="w-full md:w-1/2 text-center md:text-left">
                ...
                <div className="mb-8 border-t border-zinc-800 pt-6">
                    ...
                    <p className="text-5xl lg:text-6xl font-black text-white tracking-tight">Por <span className="text-green-400">R$ 9,00</span></p>
                </div>
                
                <a href="https://payfast.greenn.com.br/redirect/275403" className="btn-pulse-green inline-block w-full text-center bg-green-600 hover:bg-green-700 text-white font-black py-5 px-6 rounded-xl shadow-[0_0_20px_rgba(34,197,94,0.3)] transition-all text-xl uppercase tracking-wide mb-4">
                ...
                <div className="bg-zinc-800/50 p-4 rounded-lg border border-zinc-700/50 mb-4">
                    <p className="text-gray-400 text-sm leading-relaxed">
                        ...
                        Eu poderia cobrar R$ 97 por isso. Mas decidi fazer essa oferta por R$ 9 porque quero que você conheça meu método sem medo. Sei que depois de ver os resultados, você vai querer meus treinamentos avançados.
                    </p>
                </div>
                ...
                <div className="flex flex-col items-center md:items-start gap-3 mt-4">
                    ...
                    <img src="https://i.postimg.cc/LsVHTKKJ/xxxcompra_Segura_vetor_branco1_1.png" alt="Formas de Pagamento Seguras" loading="lazy" width="300" height="40" referrerPolicy="no-referrer" className="h-8 object-contain opacity-70" />
                </div>
            </div>
