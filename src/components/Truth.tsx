    ...
    <section className="py-20 lg:py-24 px-6 bg-zinc-950 text-white text-center">
        <div className="max-w-4xl mx-auto">
            ...
            <div className="inline-block border-2 border-green-500 bg-green-500/10 px-8 py-6 rounded-xl shadow-[0_0_30px_rgba(34,197,94,0.15)]">
                ...
                <a href="https://payfast.greenn.com.br/redirect/269730" className="btn-pulse-green mt-6 inline-block w-full bg-green-600 hover:bg-green-700 text-white font-black py-4 px-8 rounded-lg shadow-[0_0_20px_rgba(34,197,94,0.3)] transition-all text-lg uppercase tracking-wider">
