        ...
        <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-rose-950/30 border border-rose-900/50 p-6 rounded-xl mb-10">
                <p className="text-lg text-gray-200 font-medium leading-relaxed">
                    ...
                    O custo real não é R$ 9,00. <strong className="text-rose-400">O custo real é passar mais um final de semana olhando para a tela do celular, com um nó na garganta, aceitando migalhas de atenção enquanto ele vive a vida dele.</strong>
                </p>
            </div>
            ...
            <div className="inline-block border-2 border-green-500 bg-green-500/10 px-8 py-6 rounded-xl shadow-[0_0_30px_rgba(34,197,94,0.15)]">
                ...
                <p className="text-4xl font-black text-green-400 uppercase">R$ 9,00</p>
                <p className="text-sm font-medium text-green-500 mt-2">Pagamento Único. Sem mensalidades.</p>
                
                <a href="https://payfast.greenn.com.br/redirect/275403" className="btn-pulse-green mt-6 inline-block w-full bg-green-600 hover:bg-green-700 text-white font-black py-4 px-8 rounded-lg shadow-[0_0_20px_rgba(34,197,94,0.3)] transition-all text-lg uppercase tracking-wider">
