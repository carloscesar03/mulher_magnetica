        ...
        <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-8 lg:gap-20 items-center relative z-10">
            ...
            <div className="flex flex-col justify-center text-center lg:text-left">
                ...
                <div className="flex flex-col items-center lg:items-start w-full">
                    <a href="https://payfast.greenn.com.br/redirect/269730" className="btn-pulse-green inline-block w-full sm:w-[90%] lg:w-[90%] text-center bg-green-600 hover:bg-green-700 text-white font-black py-5 px-8 rounded-lg shadow-[0_0_20px_rgba(34,197,94,0.3)] transition-all text-lg lg:text-xl uppercase tracking-wider">
