  ...
  return (
    <section className="py-20 lg:py-24 px-6 bg-zinc-950 text-white text-center border-t border-zinc-800">
        <div className="max-w-3xl mx-auto">
            ...
            <a href="https://payfast.greenn.com.br/redirect/269730" className="btn-pulse-green inline-block w-full sm:w-auto text-center bg-green-600 hover:bg-green-700 text-white font-black py-5 px-12 rounded-lg transition-colors text-lg uppercase tracking-widest shadow-[0_0_20px_rgba(34,197,94,0.3)] mb-6">
                QUERO COMEÇAR AGORA
            </a>
